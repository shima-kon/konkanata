        ...
        <div class="topdiv">
            ...
            <nav>
                <ul class="headerul">
                    ...
                    <li class="navli"><a class="nav_btn" id="navtop" href="toiawaseform.php">お問い合わせ</a></li>
                </ul>
            </nav>
        </div>
      ...
      <div class="container">
        <div class="breadcrumb-wrapper">
          <ul class="breadcrumb">
            ...
            <li><a href="toiawaseform.php">お問い合わせ</a></li>
          </ul>
        </div>
      </div>
      ...
      <form class="Form" method="POST" action="toiawaseformkana.php">
        <div class="formtopdiv">
          <div class="toiawasepdiv">
            <p class="toiawasep">当サイトに関するお問い合わせについては、<a class="sitasen" href="https://x.com/Koncon_1135" target="_blank">管理人XのDM</a>もしくは下記のお問い合わせフォームにてお願いいたします。</p>
            <p class="toiawasetwp">※可能でしたら<a class="sitasen" href="https://x.com/Koncon_1135" target="_blank">管理人XのDM</a>にてお問い合わせください、迅速に対応できると思います。下記のフォームからの場合、返信に最大1週間程かかることがあります。ご了承ください。
            </p>
          </div>
